...
import com.gf.biz.dingSync.service.impl.UserDepartmentServiceImpl;
...
public class SyncMasterDataToCodewaveJob extends IJobHandler {
    ...
    public void execute() throws Exception {
        ...
        if(!toOptUserDeptList.isEmpty()){
            ...
            QueryWrapper<LcapUserDeptMapping> queryLcapUserDeptWrapper ;
            UpdateWrapper<LcapUserDeptMapping> updateLcapUserDeptWrapper ;
            LcapUserDeptMapping lcapUserDeptToAdd;
