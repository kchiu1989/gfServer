 ...
 * 直接获取月度平均
 */
public class CalcMonthlyPlanAchvRateIndicatorScoreJobHandler extends IJobHandler {
    private static final Logger logger = LoggerFactory.getLogger(CalcMonthlyPlanAchvRateIndicatorScoreJobHandler.class);
